...
const getAllCourseFromDB = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield schemaModel_1.CourseModel.find();
    return result;
});
const getSingleCourseFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield schemaModel_1.CourseModel.findById(id);
    return result;
});
const updateCourseFromDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield schemaModel_1.CourseModel.findByIdAndUpdate(id);
    return result;
});
