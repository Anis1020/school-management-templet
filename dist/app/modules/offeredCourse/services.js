...
const createOfferedCourseIntoDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield schemaModel_1.OfferedCourseModel.create(payload);
    return result;
});
const getAllOfferedCourseFromDB = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield schemaModel_1.OfferedCourseModel.find();
    return result;
});
const getSingleOfferedCourseFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield schemaModel_1.OfferedCourseModel.findById(id);
    return result;
});
const updateOfferedCourseFromDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield schemaModel_1.OfferedCourseModel.findByIdAndUpdate(id);
    return result;
});
